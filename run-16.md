...
- commit: `a4d7c95f2027a8e841bcf85d7b074da08b948124`
- data UTC: 2026-08-18T00:07:56Z
...
00:00 +130: PARTIDA-SBTL-3 completa: íntegra, 108 cartas e com vencedor
00:00 +131: PARTIDA-SBTL-4 completa: íntegra, 108 cartas e com vencedor
00:00 +132: All tests passed!
```
## resil (tail)
```
...
The finder corresponds to this RenderBox: RenderParagraph#71543 relayoutBoundary=up5
The hit test result at that offset is: HitTestResult(HitTestEntry<HitTestTarget>#d178f(TextSpan(debugLabel: ((englishLike bodyMedium 2021).merge((whiteMountainView bodyMedium).apply)).merge(unknown), inherit: false, color: Color(alpha: 0.3400, red: 1.0000, green: 1.0000, blue: 1.0000, colorSpace: ColorSpace.sRGB), family: Roboto, size: 8.4, weight: 700, letterSpacing: 0.3, baseline: alphabetic, height: 1.4x, leadingDistribution: even, decoration: Color(alpha: 1.0000, red: 0.9020, green: 0.8784, blue: 0.9137, colorSpace: ColorSpace.sRGB) TextDecoration.none, "em breve")), RenderParagraph#d93ba@Offset(36.6, 2.6), RenderStack#1f022@Offset(36.6, 57.4), RenderPadding#23589@Offset(37.6, 58.4), RenderPointerListener#20363@Offset(37.6, 58.4), RenderSemanticsAnnotations#7412b@Offset(37.6, 58.4), RenderMouseRegion#f31fb@Offset(37.6, 58.4), RenderSemanticsAnnotations#28869@Offset(37.6, 58.4), _RenderInkFeatures#ba97a@Offset(37.6, 58.4), RenderPhysicalModel#4d4e4@Offset(37.6, 58.4), RenderRepaintBoundary#7a39c@Offset(37.6, 58.4), RenderIndexedSemantics#1b597@Offset(37.6, 58.4), RenderSliverGrid@(mainAxis: 141.16176470588232, crossAxis: 37.625), RenderSliverPadding@(mainAxis: 141.16176470588232, crossAxis: 37.625), RenderShrinkWrappingViewport#836c1@Offset(37.6, 141.2), RenderIgnorePointer#31709@Offset(37.6, 141.2), RenderSemanticsAnnotations#7e775@Offset(37.6, 141.2), RenderPointerListener#efd1c@Offset(37.6, 141.2), RenderSemanticsGestureHandler#433de@Offset(37.6, 141.2), RenderPointerListener#a6d85@Offset(37.6, 141.2), _RenderScrollSemantics#7b4f7@Offset(37.6, 141.2), RenderClipRect#1afba@Offset(37.6, 141.2), RenderRepaintBoundary#5c587@Offset(37.6, 141.2), RenderIndexedSemantics#9b50d@Offset(37.6, 141.2), RenderSliverList@(mainAxis: 512.1617647058823, crossAxis: 37.625), RenderSliverPadding@(mainAxis: 520.1617647058823, crossAxis: 53.625), RenderViewport#690c5@Offset(53.6, 520.2), RenderIgnorePointer#89a95@Offset(53.6, 520.2), RenderSemanticsAnnotations#63cb1@Offset(53.6, 520.2), RenderPointerListener#9ea8e@Offset(53.6, 520.2), RenderSemanticsGestureHandler#d4d8b@Offset(53.6, 520.2), RenderPointerListener#24a46@Offset(53.6, 520.2), _RenderScrollSemantics#782f9@Offset(53.6, 520.2), RenderClipRect#89c3d@Offset(53.6, 520.2), _RenderLayoutBuilder#716c3@Offset(53.6, 520.2), RenderStack#cac92@Offset(53.6, 520.2), RenderFlex#25050@Offset(53.6, 520.2), RenderConstrainedBox#7961f@Offset(53.6, 520.2), RenderPositionedBox#78967@Offset(53.6, 520.2), RenderPadding#1da83@Offset(53.6, 520.2), RenderDecoratedBox#33cd6@Offset(53.6, 520.2), RenderCustomMultiChildLayoutBox#5883b@Offset(53.6, 520.2), _RenderInkFeatures#7be51@Offset(53.6, 520.2), RenderPhysicalModel#46e60@Offset(53.6, 520.2), RenderSemanticsAnnotations#4032b@Offset(53.6, 520.2), RenderRepaintBoundary#ab96c@Offset(53.6, 520.2), RenderIgnorePointer#2c058@Offset(53.6, 520.2), RenderAnimatedOpacity#151b2@Offset(53.6, 520.2), RenderAnimatedOpacity#e461c@Offset(53.6, 520.2), _RenderColoredBox#37c33@Offset(53.6, 520.2), RenderAnimatedOpacity#0c5ee@Offset(53.6, 520.2), RenderIgnorePointer#166dc@Offset(53.6, 520.2), RenderAnimatedOpacity#d6d69@Offset(53.6, 520.2), RenderRepaintBoundary#49389@Offset(53.6, 520.2), RenderSemanticsAnnotations#709f7@Offset(53.6, 520.2), RenderOffstage#1693c@Offset(53.6, 520.2), RenderSemanticsAnnotations#046e1@Offset(53.6, 520.2), _RenderTheater#39be5@Offset(53.6, 520.2), RenderAbsorbPointer#8a8e8@Offset(53.6, 520.2), RenderPointerListener#b6494@Offset(53.6, 520.2), RenderSemanticsAnnotations#292ce@Offset(53.6, 520.2), RenderSemanticsAnnotations#bbd8b@Offset(53.6, 520.2), RenderSemanticsAnnotations#b8407@Offset(53.6, 520.2), RenderSemanticsAnnotations#410a3@Offset(53.6, 520.2), RenderTapRegionSurface#14986@Offset(53.6, 520.2), RenderSemanticsAnnotations#ea6e9@Offset(53.6, 520.2), RenderSemanticsAnnotations#6a768@Offset(53.6, 520.2), HitTestEntry<HitTestTarget>#90fb1(_ReusableRenderView#f6744), HitTestEntry<HitTestTarget>#7acd0(<AutomatedTestWidgetsFlutterBinding>))
...
Compiled 10,417,716 input bytes (5,356,094 characters source) to 83,430 characters JavaScript in 0.63 seconds
```
## socialfn (tail)
```
  ---
  duration_ms: 1.228874
  type: 'suite'
  ...
