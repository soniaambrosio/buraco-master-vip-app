...
//
// A conta que sobra é desconfortável: `rm test/amigos/a11y_alvos_amigos_test.dart`
...
// `a11y_alvos_amigos_test.dart` some junto com o arquivo, e não sobra ninguém
// para reclamar. Este arquivo é o único do repositório cuja razão de existir é
