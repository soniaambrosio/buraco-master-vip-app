  ...
  void evidencia(String titulo, String nome, String legenda, ColecaoVM Function() build) {
    testWidgets(
      ...
      (tester) async {
        ...
        // Tambem dentro de `runAsync`, pelo mesmo motivo do precache acima:
        // `boundary.toImage()` e `toByteData()` sao operacoes reais do engine, e
        // no relogio falso do teste elas nunca completam — o teste ficava preso
        // em "did not complete" ate o timeout de 10 minutos, sem gravar o PNG.
        await tester.runAsync(() => _capturar(tester, nome));
      },
