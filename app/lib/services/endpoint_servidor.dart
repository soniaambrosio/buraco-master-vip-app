...
class EndpointServidor {
  ...
  static const String urlConfigurada = String.fromEnvironment(
    'BMV_SERVIDOR_URL',
  );
  ...
  static const bool permitirEndpointInseguro = bool.fromEnvironment(
    'BMV_PERMITIR_ENDPOINT_INSEGURO',
  );
  ...
  static Uri validar(
    ...
    final frouxo = permitirInseguro && perfil == PerfilDeBuild.desenvolvimento;
