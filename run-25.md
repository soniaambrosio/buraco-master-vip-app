...
- commit: `24c4cbd626033d5c30eb36e731d880df3d885d26`
- data UTC: 2026-09-25T17:22:22Z
...
198 issues found. (ran in 8.5s)
```
## motor (tail)
```
00:05 +434: OS LIXO CANÔNICO V1 — §5.2 canonizada LIX-C05 um SNAPSHOT do estado canônico é AUTOSSUFICIENTE para reproduzir a posição
00:05 +435: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-01 compra do MONTE não cria trava nenhuma
00:05 +436: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-02 compra do LIXO com UMA carta cria a trava naquela carta
00:05 +437: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-03 compra do LIXO com DUAS OU MAIS cartas NÃO cria trava
00:05 +438: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-04 no FECHADO/STBL a compra é atômica e não gera trava
00:05 +439: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-05 a trava recusa SÓ o descarte daquela carta
00:05 +440: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-06 a carta travada pode ser BAIXADA e ESTENDIDA — só não descartada
00:05 +441: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-07 a recusa é fechada: nada muda e o reasonCode é estável
00:05 +442: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-08 a informação do lixo MUDA a continuação possível do turno
00:05 +443: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-09 o MESMO estado sem a trava aceita a mesma baixada — a única diferença é o campo canônico
00:05 +444: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-10 o invariante de encerramento continua válido DEPOIS da canonização: nenhuma ação aceita cria beco
00:05 +445: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-11 a trava MORRE quando a vez passa (descarte normal)
00:05 +446: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-12 a trava SOBREVIVE às ações intermediárias do próprio turno
00:05 +447: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-13 morto DIRETO mantém a trava (mesma vez); morto INDIRETO a apaga (a vez passa)
00:05 +448: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-14 a BATIDA encerra a rodada e apaga a trava
00:05 +449: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-15 a compra do turno SEGUINTE zera qualquer resíduo
00:05 +450: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-16 clone, normalização e copyWith preservam a trava
00:05 +451: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-17 estados canônicos IGUAIS decidem IGUAL; estados que só diferem na trava não são iguais
00:05 +452: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-18 round-trip Jogo -> canônico -> Jogo preserva a trava
00:05 +453: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-19 o snapshot de Replay carrega a trava e o motor a recupera
00:05 +454: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-20 o BOT respeita a §5.2 sem nenhuma regra especial
00:05 +455: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-21 clone/simulação do bot conserva a trava
00:05 +456: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-22 gerador e aplicador NÃO divergem para o humano nem para o bot
00:05 +457: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-23 varredura de BARALHOS REAIS: a trava nunca vaza e nunca cria beco
00:05 +458: All tests passed!
```
## resil (tail)
```
...
00:01 +17: o Perfil alcançável só afirma o que tem fonte o Perfil é alcançável a partir da Home
00:01 +18: o Perfil alcançável só afirma o que tem fonte sem autoridade de ranking, nada de Bronze nem de #0
00:01 +19: o Perfil alcançável só afirma o que tem fonte progressão, estatísticas e conquistas ficam ausentes
00:01 +20: o Perfil alcançável só afirma o que tem fonte o convite copiado do Perfil alcançável não inventa nada
00:01 +21: o Perfil alcançável só afirma o que tem fonte o VM do Perfil alcançável não é a maquete
00:01 +22: estados honestos da tela pública build sem provedor operacional é terminal e sem botão
00:01 +23: estados honestos da tela pública erro de login aparece redigido
00:01 +24: transporte inicialização autenticada não abre socket nenhum
...
00:02 +27: transporte a credencial não aparece em lugar nenhum da interface
00:02 +28: sem conexão, o ciclo automático desiste e diz isso
00:02 +29: endereço de servidor inválido é falha terminal, não tentativa
...
The finder corresponds to this RenderBox: RenderParagraph#1b20c relayoutBoundary=up5
The hit test result at that offset is: HitTestResult(HitTestEntry<HitTestTarget>#7d9cb(TextSpan(debugLabel: ((englishLike bodyMedium 2021).merge((whiteMountainView bodyMedium).apply)).merge(unknown), inherit: false, color: Color(alpha: 0.3400, red: 1.0000, green: 1.0000, blue: 1.0000, colorSpace: ColorSpace.sRGB), family: Roboto, size: 8.4, weight: 700, letterSpacing: 0.3, baseline: alphabetic, height: 1.4x, leadingDistribution: even, decoration: Color(alpha: 1.0000, red: 0.9020, green: 0.8784, blue: 0.9137, colorSpace: ColorSpace.sRGB) TextDecoration.none, "em breve")), RenderParagraph#dbb6b@Offset(36.6, 2.6), RenderStack#0f187@Offset(36.6, 57.4), RenderPadding#dd81c@Offset(37.6, 58.4), RenderPointerListener#08337@Offset(37.6, 58.4), RenderSemanticsAnnotations#ef60e@Offset(37.6, 58.4), RenderMouseRegion#82208@Offset(37.6, 58.4), RenderSemanticsAnnotations#a8e19@Offset(37.6, 58.4), _RenderInkFeatures#a1324@Offset(37.6, 58.4), RenderPhysicalModel#2f938@Offset(37.6, 58.4), RenderRepaintBoundary#6f636@Offset(37.6, 58.4), RenderIndexedSemantics#5a623@Offset(37.6, 58.4), RenderSliverGrid@(mainAxis: 58.38725490196077, crossAxis: 206.125), RenderSliverPadding@(mainAxis: 58.38725490196077, crossAxis: 206.125), RenderShrinkWrappingViewport#c6d0e@Offset(206.1, 58.4), RenderIgnorePointer#4ebe5@Offset(206.1, 58.4), RenderSemanticsAnnotations#30bea@Offset(206.1, 58.4), RenderPointerListener#b34ed@Offset(206.1, 58.4), RenderSemanticsGestureHandler#e771a@Offset(206.1, 58.4), RenderPointerListener#dff07@Offset(206.1, 58.4), _RenderScrollSemantics#7eaf5@Offset(206.1, 58.4), RenderClipRect#6f0ce@Offset(206.1, 58.4), RenderRepaintBoundary#90f87@Offset(206.1, 58.4), RenderIndexedSemantics#f3b8e@Offset(206.1, 58.4), RenderSliverList@(mainAxis: 429.3872549019608, crossAxis: 206.125), RenderSliverPadding@(mainAxis: 437.3872549019608, crossAxis: 222.125), RenderViewport#d14ae@Offset(222.1, 437.4), RenderIgnorePointer#dfddb@Offset(222.1, 437.4), RenderSemanticsAnnotations#e74f4@Offset(222.1, 437.4), RenderPointerListener#7df7c@Offset(222.1, 437.4), RenderSemanticsGestureHandler#0c0d5@Offset(222.1, 437.4), RenderPointerListener#e82cb@Offset(222.1, 437.4), _RenderScrollSemantics#5c331@Offset(222.1, 437.4), RenderClipRect#4f4ba@Offset(222.1, 437.4), _RenderLayoutBuilder#3b5d9@Offset(222.1, 437.4), RenderStack#6c2e2@Offset(222.1, 437.4), RenderFlex#a0511@Offset(222.1, 437.4), RenderConstrainedBox#04a26@Offset(222.1, 437.4), RenderPositionedBox#2a2df@Offset(222.1, 437.4), RenderPadding#db282@Offset(222.1, 437.4), RenderDecoratedBox#161ef@Offset(222.1, 437.4), RenderCustomMultiChildLayoutBox#d5dc6@Offset(222.1, 437.4), _RenderInkFeatures#afff9@Offset(222.1, 437.4), RenderPhysicalModel#2a048@Offset(222.1, 437.4), RenderSemanticsAnnotations#a9873@Offset(222.1, 437.4), RenderRepaintBoundary#51326@Offset(222.1, 437.4), RenderIgnorePointer#f5dd6@Offset(222.1, 437.4), RenderAnimatedOpacity#daffd@Offset(222.1, 437.4), RenderAnimatedOpacity#416cd@Offset(222.1, 437.4), _RenderColoredBox#8a58f@Offset(222.1, 437.4), RenderAnimatedOpacity#eee74@Offset(222.1, 437.4), RenderIgnorePointer#0315b@Offset(222.1, 437.4), RenderAnimatedOpacity#a7cae@Offset(222.1, 437.4), RenderRepaintBoundary#0f1a9@Offset(222.1, 437.4), RenderSemanticsAnnotations#05a39@Offset(222.1, 437.4), RenderOffstage#3ec74@Offset(222.1, 437.4), RenderSemanticsAnnotations#ae6ec@Offset(222.1, 437.4), _RenderTheater#a9666@Offset(222.1, 437.4), RenderAbsorbPointer#ce45b@Offset(222.1, 437.4), RenderPointerListener#ee311@Offset(222.1, 437.4), RenderSemanticsAnnotations#2649d@Offset(222.1, 437.4), RenderSemanticsAnnotations#18a40@Offset(222.1, 437.4), RenderSemanticsAnnotations#f5adc@Offset(222.1, 437.4), RenderSemanticsAnnotations#768f5@Offset(222.1, 437.4), RenderTapRegionSurface#61437@Offset(222.1, 437.4), RenderSemanticsAnnotations#b91a6@Offset(222.1, 437.4), RenderSemanticsAnnotations#78c9e@Offset(222.1, 437.4), HitTestEntry<HitTestTarget>#a2e37(_ReusableRenderView#462dc), HitTestEntry<HitTestTarget>#71731(<AutomatedTestWidgetsFlutterBinding>))
...
00:01 +12: Amigos navega, e o que abre consulta a autoridade
...
00:00 +2: treino Treino não abre socket e não pede credencial
00:00 +3: transporte Mesa por código usa o OnlineService da raiz
...
00:02 +11: a mão alheia não aparece só a própria mão é desenhada; das outras, a contagem
00:02 +12: a mão alheia não aparece cartas de outros assentos na visão não vazam para a tela
00:02 +13: comandos comprar do monte manda a jogada do protocolo
00:02 +14: comandos duplo toque não envia duas intenções
00:02 +15: comandos a intenção pendente aparece na tela
00:03 +16: comandos descartar exige uma carta selecionada e manda o id dela
00:03 +17: comandos baixar manda a lista de ids selecionados
00:03 +18: comandos fora da minha vez não há ação oferecida
00:03 +19: comandos recusa de regra preserva o estado autoritativo
00:03 +20: queda e retomada a queda bloqueia ações novas e avisa
00:03 +21: queda e retomada a mesa continua desenhada durante a reconexão
00:04 +22: queda e retomada a retomada substitui a mesa pela visão nova
00:04 +23: sessão e saída logout EM PARTIDA encerra a capacidade de jogar
00:04 +24: sessão e saída trocar de conta elimina a pilha e o estado visual anterior
00:04 +25: sessão e saída sair da mesa não é sair da conta
00:04 +26: sessão e saída falha terminal oferece ação explícita, sem laço
00:04 +27: desfecho o encerramento autoritativo mostra o resultado uma vez
00:04 +28: desfecho quem bateu é lido do servidor, não do placar
00:04 +29: desfecho partida encerrada sem quem bateu não anuncia vencedor
00:05 +30: desfecho encerrada a partida, nenhuma ação é oferecida
00:05 +31: nada de segredo na tela a credencial não aparece em texto nenhum da mesa
00:05 +32: nada de segredo na tela nenhuma conquista é concedida por inferência do cliente
...
00:00 +3: a Loja é alcançável a partir da casca o ‹ da Loja volta para a Home, que continua viva
00:00 +4: a Loja respeita a sessão o Billing é montado com o uid da sessão canônica
...
00:01 +14: fora do escopo, a montagem é a de PRODUÇÃO
00:01 +15: a Loja está no fecho de imports da raiz de produção
...
## rkestado (tail)
```
00:00 +21: carregando e erro não viram dado erro depois de carregado não deixa resto do perfil na tela
00:00 +22: PerfilService — o produtor a chave de demonstração segue desligada
00:00 +23: PerfilService — o produtor o perfil publicável não recebe liga nem colocação
...
00:00 +40: auditoria — o literal competitivo não pode nascer no cliente a região das callables casa com a do backend
00:00 +41: auditoria — o literal competitivo não pode nascer no cliente (tearDownAll)
...
00:00 +9: C1 — o Perfil próprio bebe do escopo de ranking C8 — sem nível, nada de "Nível null" na tela nem no convite
00:00 +10: C1 — o Perfil próprio bebe do escopo de ranking C9 — sem liga, nada de Bronze na tela nem no convite
00:00 +11: C1 — o Perfil próprio bebe do escopo de ranking C10 — sem colocação, nada de #0 nem de #1
00:00 +12: C11–C16 — as autoridades continuam únicas (setUpAll)
00:00 +12: C11–C16 — as autoridades continuam únicas C11 — o PerfilService não consulta ranking
00:00 +13: C11–C16 — as autoridades continuam únicas C11b — só o adaptador de Firebase conhece cloud_functions
00:00 +14: C11–C16 — as autoridades continuam únicas C11c — só a cadeia de sessão observa o Firebase Auth
...
## contratosui (tail)
```
TESTEMUNHA: desafio desta corrida: testemunha-4951-20260925T171241Z
...
TESTEMUNHA: desafio testemunha-4951-20260925T171241Z
...
Compiled 10,446,208 input bytes (5,381,931 characters source) to 87,989 characters JavaScript in 0.53 seconds
```
## socialfn (tail)
```
  ---
  duration_ms: 1.572973
  type: 'suite'
  ...
...
# skipped 0
# todo 0
# duration_ms 73.17727
```
## socialemu (tail)
```
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 6.892202ms
...
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 7.092243ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 7.89399ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 7.105265ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 7.190264ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 7.052722ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 15.046224ms
...
```
    ...
    ok 3 - PROV-12 toda source existe, e nenhum `ignore` exclui o carimbo
      ---
      duration_ms: 0.267505
      ...
    1..3
ok 3 - §16 — a arvore REAL desta composicao
  ---
  duration_ms: 1.674536
  type: 'suite'
  ...
1..3
# tests 13
...
00:00 +8: jogador local x outro jogador tocar em si mesmo abre o proprio perfil
00:00 +9: jogador local x outro jogador jogador sem id publicado nao navega
00:00 +10: paginacao na tela sem proxima pagina, o botao nem aparece
00:00 +11: paginacao na tela carregar mais concatena e some no fim da lista
...
# skipped 0
# todo 0
# duration_ms 196.761971
```
## avatarcanon (tail)
```
00:01 +16: reatividade M13 logout remove o avatar anterior
00:01 +17: reatividade M13b logout COM O PERFIL ABERTO apaga o avatar na hora
00:01 +18: reatividade M14b troca de jogador COM O PERFIL ABERTO não vaza o antigo
00:01 +19: reatividade M14 login de outro jogador não mostra o avatar do anterior
00:01 +20: reatividade M15 mudança de publicId invalida o estado anterior
00:01 +21: reatividade M16 Perfil em carregamento não inventa avatar definitivo
00:01 +22: reatividade referência válida que depois fica inválida cai no fallback
00:01 +23: o que não podia mudar M17 nome, ranking e moldura seguem intactos
00:01 +24: o que não podia mudar M23 o convite compartilhado continua funcional e sem o avatar
00:01 +25: o que não podia mudar M19 main.dart continua byte a byte o da base
00:01 +26: o que não podia mudar M22 Mesa Online e Mesa de Treino ficam fora do assunto
...
00:02 +37: auditoria estrutural o resolvedor não conhece Flutter, Firebase nem armazenamento
00:02 +38: auditoria estrutural (tearDownAll)
00:02 +38: All tests passed!
```
## avatarhml (tail)
```
00:00 +20: H-C Perfil H-C05 o serviço resolve o avatar pela identidade, não por constante
00:00 +21: H-C Perfil H-C06 o Perfil não busca nome nem avatar no Firebase Auth
00:00 +22: H-D identidade em movimento H-D01 chegada tardia: fallback antes, referência depois
00:00 +23: H-D identidade em movimento H-D02 avatarRef muda com o MESMO publicId
...
00:01 +26: H-D identidade em movimento H-D05 na janela da troca A→B o avatar de A não pisca
00:01 +27: H-D identidade em movimento H-D06 resposta ATRASADA da conta A não contamina a conta B
00:01 +28: H-D identidade em movimento H-D07 válida→inválida e inválida→válida, nos dois sentidos
00:01 +29: H-D identidade em movimento H-D08 60 reconstruções de cada tela não emitem chamada
00:02 +30: H-D identidade em movimento H-D09 abrir e fechar o Perfil 6 vezes não emite chamada
00:02 +31: H-D identidade em movimento H-D11 a troca de avatar não devolve o Perfil ao esqueleto
00:02 +32: H-D identidade em movimento H-D10 falha de identidade não inventa avatar
00:02 +33: H-E auditoria estrutural (setUpAll)
00:02 +33: H-E auditoria estrutural H-E01 main.dart continua byte a byte o da base
00:02 +34: H-E auditoria estrutural H-E02 authStateChanges tem UM assinante, e é a sessão
00:02 +35: H-E auditoria estrutural H-E03 obterMinhaIdentidade é chamado de UM lugar só
00:02 +36: H-E auditoria estrutural H-E04 nem Home nem Perfil alcançam Firestore ou publicProfiles
00:02 +37: H-E auditoria estrutural H-E05 o fecho cresceu só pelo resolvedor
00:02 +38: H-E auditoria estrutural H-E06 a coroa tem UM dono NA FUNÇÃO DE AVATAR
00:02 +39: H-E auditoria estrutural H-E07 nenhuma tela inventa catálogo nem mapeia referência a arquivo
00:02 +40: H-E auditoria estrutural H-E09 nenhum produtor de produção escreve um avatar literal
00:02 +41: H-E auditoria estrutural H-E08 o delta não carrega credencial, segredo nem dado pessoal
00:02 +42: H-E auditoria estrutural (tearDownAll)
...
00:00 +11: assíncrono V10 três toques em B produzem UMA consulta
00:00 +12: a chave é o publicId V11 publicId vazio não navega nem consulta
00:00 +13: a chave é o publicId V12 apelido não vira chave
00:00 +14: a chave é o publicId V13 posição não vira chave
00:00 +15: a chave é o publicId V14 índice de lista não vira chave
00:00 +16: a chave é o publicId V-mesmo-id o próprio publicId pela porta pública converge
00:00 +17: falha, fallback e privacidade V15 falha na leitura pública NÃO cai para a sessão
00:00 +18: falha, fallback e privacidade V15b classificado:false também não vaza a visitante
00:00 +19: falha, fallback e privacidade V16 avatar ausente do visitado usa o fallback PÚBLICO
00:00 +20: falha, fallback e privacidade V16b referência malformada cai no mesmo fallback
...
## rknavpub (tail)
```
00:00 +16: N3–N10 — a decisão de qual Perfil abrir N14 — voltar do Perfil público preserva o ranking
00:00 +17: N3–N10 — a decisão de qual Perfil abrir N15 — cada linha é um botão com área de toque suficiente
00:00 +18: N6–N9 — voo, cache e troca de sessão N6 — três toques no MESMO terceiro reutilizam o voo
00:00 +19: N6–N9 — voo, cache e troca de sessão N6b — abertura e projeção compartilham UM voo
00:00 +20: N6–N9 — voo, cache e troca de sessão N7 — dois terceiros NÃO compartilham cache nem voo
00:00 +21: N6–N9 — voo, cache e troca de sessão N8 — troca de sessão esvazia cache e desarma os voos antigos
00:00 +22: N6–N9 — voo, cache e troca de sessão N9 — resposta antiga não substitui a sessão nova
00:00 +23: N6–N9 — voo, cache e troca de sessão N8b — a tabela morre junto com a sessão
00:00 +24: N11 — os estados da tela N11a — CARREGANDO não desenha lista nem "ninguém"
00:00 +25: N11 — os estados da tela N11b — VAZIO só é dito quando a autoridade respondeu
00:00 +26: N11 — os estados da tela N11c — ACESSO RECUSADO é neutro e oferece insistir
...
00:01 +37: N16 — o Perfil abre o ranking real N16b — sem callback, a linha competitiva não vira botão
...
00:00 +6: Perfil — um VM só, enriquecido duas vezes Home e Perfil concordam no avatar E no estado competitivo
00:00 +7: Perfil — um VM só, enriquecido duas vezes avatar ausente: Home e Perfil caem no MESMO fallback
00:00 +8: Perfil — um VM só, enriquecido duas vezes perfil de terceiro: o Ranking é o do publicId visitado
00:00 +9: Perfil — um VM só, enriquecido duas vezes perfil de terceiro sem publicId não afirma ranking nenhum
...
00:00 +10: C5–C11 — jogadores públicos, sem uid e sem palpite C8 publicId vazio não navega
00:00 +11: C5–C11 — jogadores públicos, sem uid e sem palpite C9 apelido não vira identificador
00:00 +12: C5–C11 — jogadores públicos, sem uid e sem palpite C10 posição não vira identificador
00:00 +13: C5–C11 — jogadores públicos, sem uid e sem palpite C11 índice de lista não vira identificador
00:00 +14: C5–C11 — jogadores públicos, sem uid e sem palpite C6b duas visitas seguidas consultam os DOIS ids
00:00 +15: C12–C15 — as invariantes da base sob a tabela nova C12 o avatar canônico segue no cabeçalho da Home
00:00 +16: C12–C15 — as invariantes da base sob a tabela nova C12b avatar ausente cai no fallback DA AUTORIDADE
...
00:00 +6: busca — os botões são os do servidor, e o estado volta a tela desenha SÓ as ações que a autoridade ofereceu
00:00 +7: busca — os botões são os do servidor, e o estado volta adicionar reflete a vista NOVA da autoridade na mesma linha
00:00 +8: busca — os botões são os do servidor, e o estado volta busca truncada convida a refinar, e não oferece "mais"
00:00 +9: busca — os botões são os do servidor, e o estado volta recusa de termo curto vira recado sobre o TEXTO
00:00 +10: navegação — o publicId, e nunca a posição tocar num amigo abre o Perfil daquele publicId
...
## a11yamigos (tail)
```
00:03 +51: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — busca com resultado
00:03 +52: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — busca truncada
00:03 +53: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — busca truncada
00:03 +54: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — busca truncada
00:04 +55: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — falha de lista
00:04 +56: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — falha de lista
00:04 +57: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — falha de lista
00:04 +58: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — falha de busca
00:04 +59: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — falha de busca
00:04 +60: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — falha de busca
00:04 +61: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — vazio
00:04 +62: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — vazio
00:04 +63: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — vazio
00:04 +64: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — carregando
00:04 +65: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — carregando
00:04 +66: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — carregando
00:04 +67: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — fora do escopo
00:04 +68: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — fora do escopo
00:04 +69: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — fora do escopo
00:04 +70: 5 — vazio, carregando, erro e conteúdo 5a — vazio diz a frase da aba, e não desenha alvo de lista
00:04 +71: 5 — vazio, carregando, erro e conteúdo 5b — carregando mostra o progresso
00:04 +72: 5 — vazio, carregando, erro e conteúdo 5c — erro oferece Tentar de novo, no piso
00:04 +73: 5 — vazio, carregando, erro e conteúdo 5d — conteúdo continua desenhando quem o servidor mandou
00:04 +74: 5 — vazio, carregando, erro e conteúdo 5e — fora do escopo diz o motivo, e o Voltar continua no piso
00:04 +75: All tests passed!
```
