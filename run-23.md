...
- commit: `603f0e1fce21787ac003a1b5c5cfd957e3984d77`
- data UTC: 2026-09-19T17:59:10Z
...
198 issues found. (ran in 13.6s)
```
## motor (tail)
```
00:10 +434: OS LIXO CANÔNICO V1 — §5.2 canonizada LIX-C05 um SNAPSHOT do estado canônico é AUTOSSUFICIENTE para reproduzir a posição
00:10 +435: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-01 compra do MONTE não cria trava nenhuma
00:10 +436: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-02 compra do LIXO com UMA carta cria a trava naquela carta
00:10 +437: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-03 compra do LIXO com DUAS OU MAIS cartas NÃO cria trava
00:10 +438: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-04 no FECHADO/STBL a compra é atômica e não gera trava
00:10 +439: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-05 a trava recusa SÓ o descarte daquela carta
00:10 +440: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-06 a carta travada pode ser BAIXADA e ESTENDIDA — só não descartada
00:10 +441: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-07 a recusa é fechada: nada muda e o reasonCode é estável
00:10 +442: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-08 a informação do lixo MUDA a continuação possível do turno
00:10 +443: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-09 o MESMO estado sem a trava aceita a mesma baixada — a única diferença é o campo canônico
00:10 +444: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-10 o invariante de encerramento continua válido DEPOIS da canonização: nenhuma ação aceita cria beco
00:10 +445: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-11 a trava MORRE quando a vez passa (descarte normal)
00:10 +446: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-12 a trava SOBREVIVE às ações intermediárias do próprio turno
00:10 +447: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-13 morto DIRETO mantém a trava (mesma vez); morto INDIRETO a apaga (a vez passa)
00:10 +448: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-14 a BATIDA encerra a rodada e apaga a trava
00:10 +449: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-15 a compra do turno SEGUINTE zera qualquer resíduo
00:10 +450: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-16 clone, normalização e copyWith preservam a trava
00:10 +451: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-17 estados canônicos IGUAIS decidem IGUAL; estados que só diferem na trava não são iguais
00:10 +452: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-18 round-trip Jogo -> canônico -> Jogo preserva a trava
00:10 +453: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-19 o snapshot de Replay carrega a trava e o motor a recupera
00:10 +454: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-20 o BOT respeita a §5.2 sem nenhuma regra especial
00:10 +455: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-21 clone/simulação do bot conserva a trava
00:10 +456: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-22 gerador e aplicador NÃO divergem para o humano nem para o bot
00:10 +457: OS LIXO CANÔNICO V1 — regra do ABERTO LIX-23 varredura de BARALHOS REAIS: a trava nunca vaza e nunca cria beco
00:10 +458: All tests passed!
```
## resil (tail)
```
...
00:03 +19: o Perfil alcançável só afirma o que tem fonte progressão, estatísticas e conquistas ficam ausentes
...
00:04 +26: transporte logout fecha o socket e cancela a reconexão
...
00:01 +14: transporte único a raiz monta a ponte de sessão
00:01 +15: transporte único a raiz não conecta o transporte sozinha
00:01 +16: sessão, casca e transporte não escrevem em log
00:01 +17: o portão da identidade visitada a suíte existe na árvore
00:01 +18: o portão da identidade visitada o workflow a executa e a considera no portão
00:01 +19: o portão da atestação Android a suíte existe na árvore
00:01 +20: o portão da atestação Android o workflow a executa e a considera no portão
00:01 +21: o portão da atestação Android o verificador de contrato exige o gate e não deixa o piso cair
00:01 +22: (tearDownAll)
...
The finder corresponds to this RenderBox: RenderParagraph#df6c5 relayoutBoundary=up5
The hit test result at that offset is: HitTestResult(HitTestEntry<HitTestTarget>#998d3(TextSpan(debugLabel: ((englishLike bodyMedium 2021).merge((whiteMountainView bodyMedium).apply)).merge(unknown), inherit: false, color: Color(alpha: 0.3400, red: 1.0000, green: 1.0000, blue: 1.0000, colorSpace: ColorSpace.sRGB), family: Roboto, size: 8.4, weight: 700, letterSpacing: 0.3, baseline: alphabetic, height: 1.4x, leadingDistribution: even, decoration: Color(alpha: 1.0000, red: 0.9020, green: 0.8784, blue: 0.9137, colorSpace: ColorSpace.sRGB) TextDecoration.none, "em breve")), RenderParagraph#9ea30@Offset(36.6, 2.6), RenderStack#d7da5@Offset(36.6, 57.4), RenderPadding#a0cf8@Offset(37.6, 58.4), RenderPointerListener#2db66@Offset(37.6, 58.4), RenderSemanticsAnnotations#1beb0@Offset(37.6, 58.4), RenderMouseRegion#03cda@Offset(37.6, 58.4), RenderSemanticsAnnotations#3384c@Offset(37.6, 58.4), _RenderInkFeatures#0c105@Offset(37.6, 58.4), RenderPhysicalModel#caba6@Offset(37.6, 58.4), RenderRepaintBoundary#f00cd@Offset(37.6, 58.4), RenderIndexedSemantics#3ee23@Offset(37.6, 58.4), RenderSliverGrid@(mainAxis: 58.38725490196077, crossAxis: 206.125), RenderSliverPadding@(mainAxis: 58.38725490196077, crossAxis: 206.125), RenderShrinkWrappingViewport#9d169@Offset(206.1, 58.4), RenderIgnorePointer#c6ab5@Offset(206.1, 58.4), RenderSemanticsAnnotations#c56b7@Offset(206.1, 58.4), RenderPointerListener#7d3d5@Offset(206.1, 58.4), RenderSemanticsGestureHandler#94fba@Offset(206.1, 58.4), RenderPointerListener#63c1b@Offset(206.1, 58.4), _RenderScrollSemantics#e8dd6@Offset(206.1, 58.4), RenderClipRect#f0957@Offset(206.1, 58.4), RenderRepaintBoundary#84bac@Offset(206.1, 58.4), RenderIndexedSemantics#cc194@Offset(206.1, 58.4), RenderSliverList@(mainAxis: 429.3872549019608, crossAxis: 206.125), RenderSliverPadding@(mainAxis: 437.3872549019608, crossAxis: 222.125), RenderViewport#3206d@Offset(222.1, 437.4), RenderIgnorePointer#29219@Offset(222.1, 437.4), RenderSemanticsAnnotations#9947e@Offset(222.1, 437.4), RenderPointerListener#e3c4b@Offset(222.1, 437.4), RenderSemanticsGestureHandler#a739f@Offset(222.1, 437.4), RenderPointerListener#21367@Offset(222.1, 437.4), _RenderScrollSemantics#ccf18@Offset(222.1, 437.4), RenderClipRect#d1978@Offset(222.1, 437.4), _RenderLayoutBuilder#bb9b4@Offset(222.1, 437.4), RenderStack#c5a0c@Offset(222.1, 437.4), RenderFlex#ec7a1@Offset(222.1, 437.4), RenderConstrainedBox#ea8a1@Offset(222.1, 437.4), RenderPositionedBox#bf6db@Offset(222.1, 437.4), RenderPadding#ac2f1@Offset(222.1, 437.4), RenderDecoratedBox#7f12c@Offset(222.1, 437.4), RenderCustomMultiChildLayoutBox#bd771@Offset(222.1, 437.4), _RenderInkFeatures#67976@Offset(222.1, 437.4), RenderPhysicalModel#50472@Offset(222.1, 437.4), RenderSemanticsAnnotations#fdb6d@Offset(222.1, 437.4), RenderRepaintBoundary#0406e@Offset(222.1, 437.4), RenderIgnorePointer#0596f@Offset(222.1, 437.4), RenderAnimatedOpacity#65de6@Offset(222.1, 437.4), RenderAnimatedOpacity#d7c2c@Offset(222.1, 437.4), _RenderColoredBox#0ce78@Offset(222.1, 437.4), RenderAnimatedOpacity#3a888@Offset(222.1, 437.4), RenderIgnorePointer#8867d@Offset(222.1, 437.4), RenderAnimatedOpacity#f2f5b@Offset(222.1, 437.4), RenderRepaintBoundary#defb8@Offset(222.1, 437.4), RenderSemanticsAnnotations#13299@Offset(222.1, 437.4), RenderOffstage#b2f4e@Offset(222.1, 437.4), RenderSemanticsAnnotations#1cacc@Offset(222.1, 437.4), _RenderTheater#25ee4@Offset(222.1, 437.4), RenderAbsorbPointer#ab964@Offset(222.1, 437.4), RenderPointerListener#552a6@Offset(222.1, 437.4), RenderSemanticsAnnotations#cd2ad@Offset(222.1, 437.4), RenderSemanticsAnnotations#463e8@Offset(222.1, 437.4), RenderSemanticsAnnotations#b0ecc@Offset(222.1, 437.4), RenderSemanticsAnnotations#41a23@Offset(222.1, 437.4), RenderTapRegionSurface#7d48b@Offset(222.1, 437.4), RenderSemanticsAnnotations#2f475@Offset(222.1, 437.4), RenderSemanticsAnnotations#df3a4@Offset(222.1, 437.4), HitTestEntry<HitTestTarget>#19288(_ReusableRenderView#386e5), HitTestEntry<HitTestTarget>#1c91b(<AutomatedTestWidgetsFlutterBinding>))
...
00:03 +12: Amigos navega, e o que abre consulta a autoridade
...
00:02 +4: transporte abrir e fechar o lobby não constrói um segundo transporte
...
00:04 +10: a visão que não descreve uma mesa a mesma visão duas vezes não acumula nada
00:04 +11: a mão alheia não aparece só a própria mão é desenhada; das outras, a contagem
...
00:05 +14: comandos duplo toque não envia duas intenções
00:05 +15: comandos a intenção pendente aparece na tela
00:05 +16: comandos descartar exige uma carta selecionada e manda o id dela
00:06 +17: comandos baixar manda a lista de ids selecionados
00:06 +18: comandos fora da minha vez não há ação oferecida
...
00:07 +21: queda e retomada a mesa continua desenhada durante a reconexão
00:07 +22: queda e retomada a retomada substitui a mesa pela visão nova
00:07 +23: sessão e saída logout EM PARTIDA encerra a capacidade de jogar
00:07 +24: sessão e saída trocar de conta elimina a pilha e o estado visual anterior
00:08 +25: sessão e saída sair da mesa não é sair da conta
00:08 +26: sessão e saída falha terminal oferece ação explícita, sem laço
00:08 +27: desfecho o encerramento autoritativo mostra o resultado uma vez
00:08 +28: desfecho quem bateu é lido do servidor, não do placar
00:08 +29: desfecho partida encerrada sem quem bateu não anuncia vencedor
00:09 +30: desfecho encerrada a partida, nenhuma ação é oferecida
00:09 +31: nada de segredo na tela a credencial não aparece em texto nenhum da mesa
00:09 +32: nada de segredo na tela nenhuma conquista é concedida por inferência do cliente
00:09 +33: All tests passed!
```
## cascaporta (tail)
```
...
00:01 +1: a Loja é alcançável a partir da casca o item da Loja não está mais apagado na grade
00:01 +2: a Loja é alcançável a partir da casca os Ajustes também abrem a Loja
...
00:02 +5: a Loja respeita a sessão sair da conta com a Loja aberta descarta a Loja
00:02 +6: a Loja respeita a sessão sem sessão a Loja nem é alcançável
00:02 +7: a Loja de produção não desenha dado sem fonte o VM não traz carteira, pacote, cosmético nem amigo
00:02 +8: a Loja de produção não desenha dado sem fonte as seções de maquete não chegam à tela
00:02 +9: a Loja de produção não desenha dado sem fonte sem planos, a vitrine explica em vez de ficar vazia
00:02 +10: o VIP vem do backend, e só dele a Loja abre sem VIP quando não há documento
00:02 +11: o VIP vem do backend, e só dele o entitlement do backend acende o selo
00:02 +12: o VIP vem do backend, e só dele tocar em assinar NÃO acende o VIP
00:03 +13: o VIP vem do backend, e só dele a Loja fechada não deixa escuta aberta
00:03 +14: fora do escopo, a montagem é a de PRODUÇÃO
00:03 +15: a Loja está no fecho de imports da raiz de produção
...
00:03 +36: sessão — nada sobrevive à troca troca de conta sem logout não reaproveita nada da geração anterior
...
00:01 +6: PROBE — a tela não desenha o que não tem fonte XP exige os TRÊS campos: nenhum subconjunto desenha barra
...
00:02 +15: PROBE — a mesma fonte canônica em toda superfície o serviço publicável não entrega nenhum dos oito absorvidos
...
00:01 +31: a linha competitiva é anunciada, e não soletrada CASO 21c — ranking indisponível
...
00:01 +19: B — a tela não promete o que o botão não cumpre B11 — o acesso recusado oferece tentar de novo, e o botão da tela é o que cumpre a promessa
...
00:02 +17: C11–C16 — as autoridades continuam únicas C16 — main.dart permanece byte a byte o das duas entradas
00:02 +18: C11–C16 — as autoridades continuam únicas C17 — o ranking é alcançável pela raiz, e por um caminho só
00:02 +19: C11–C16 — as autoridades continuam únicas (tearDownAll)
...
## contratosui (tail)
```
TESTEMUNHA: desafio desta corrida: testemunha-5169-20260919T174450Z
...
TESTEMUNHA: desafio testemunha-5169-20260919T174450Z
...
Compiled 10,446,208 input bytes (5,381,931 characters source) to 87,989 characters JavaScript in 0.89 seconds
```
## socialfn (tail)
```
  ---
  duration_ms: 2.729712
  type: 'suite'
  ...
...
# skipped 0
# todo 0
# duration_ms 135.08241
```
## socialemu (tail)
```
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 11.691864ms
...
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 11.848515ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 13.290884ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 11.657688ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 12.189805ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 15.458595ms
[36m[1mi  functions:[22m[39m Beginning execution of "southamerica-east1-aoBloquearJogador"
[90m> [39m {"desfez":false,"severity":"INFO","message":"faxina social por bloqueio"}
[36m[1mi  functions:[22m[39m Finished "southamerica-east1-aoBloquearJogador" in 12.082995ms
...
ok 55 - Functions sociais # SKIP
  ---
  duration_ms: 0.147395
  type: 'suite'
  ...
1..55
# tests 252
...
```
    ...
    ok 3 - PROV-12 toda source existe, e nenhum `ignore` exclui o carimbo
      ---
      duration_ms: 0.408906
      ...
    1..3
ok 3 - §16 — a arvore REAL desta composicao
  ---
  duration_ms: 2.417565
  type: 'suite'
  ...
1..3
# tests 13
...
00:01 +3: estados erro mostra o motivo da fonte e o botao de tentar de novo
00:01 +4: estados tentar de novo refaz a busca e recupera a lista
00:01 +5: sem fonte oficial (caminho de producao) a tela diz que nao ha ranking publicado, sem inventar nome
00:01 +6: jogador local x outro jogador so a linha marcada pela fonte recebe o selo VOCE
00:01 +7: jogador local x outro jogador tocar em outro jogador abre o perfil dele pelo id publico
...
00:02 +13: abas trocar de aba busca a nova, e voltar nao rebusca
00:02 +14: descarte sair da tela antes da resposta nao quebra nada
00:02 +15: superficie pequena 320x640 desenha a lista sem estouro
00:02 +16: All tests passed!
```
## composloja (tail)
```
  ---
  duration_ms: 2.334229
  type: 'suite'
  ...
...
# skipped 0
# todo 0
# duration_ms 306.449566
```
## avatarcanon (tail)
```
00:03 +16: reatividade M13 logout remove o avatar anterior
00:03 +17: reatividade M13b logout COM O PERFIL ABERTO apaga o avatar na hora
00:03 +18: reatividade M14b troca de jogador COM O PERFIL ABERTO não vaza o antigo
00:03 +19: reatividade M14 login de outro jogador não mostra o avatar do anterior
00:03 +20: reatividade M15 mudança de publicId invalida o estado anterior
00:03 +21: reatividade M16 Perfil em carregamento não inventa avatar definitivo
00:03 +22: reatividade referência válida que depois fica inválida cai no fallback
00:03 +23: o que não podia mudar M17 nome, ranking e moldura seguem intactos
00:03 +24: o que não podia mudar M23 o convite compartilhado continua funcional e sem o avatar
00:03 +25: o que não podia mudar M19 main.dart continua byte a byte o da base
00:03 +26: o que não podia mudar M22 Mesa Online e Mesa de Treino ficam fora do assunto
00:03 +27: o que não podia mudar M24 as coroas ornamentais continuam onde estavam
00:03 +28: auditoria estrutural (setUpAll)
00:03 +28: auditoria estrutural M20 o Perfil não abriu consulta nova a publicProfiles
00:03 +29: auditoria estrutural a autoridade do avatar é UMA, e mora no resolvedor
00:03 +30: auditoria estrutural o fallback é literal em um lugar só do fecho alcançável
00:04 +31: auditoria estrutural M21 nenhum literal Bronze reaparece no fecho alcançável
00:04 +32: auditoria estrutural M21b e nenhuma liga é AFIRMADA pelo caminho publicável
00:04 +33: auditoria estrutural o fecho cresceu só pelo componente previsto
00:04 +34: auditoria estrutural o Hall continua alcançável, e por um produtor de verdade
00:04 +35: auditoria estrutural nada do que a OS proíbe entrou no fecho
00:04 +36: auditoria estrutural M18 authStateChanges continua com um assinante só
00:04 +37: auditoria estrutural o resolvedor não conhece Flutter, Firebase nem armazenamento
00:04 +38: auditoria estrutural (tearDownAll)
...
00:02 +24: H-D identidade em movimento H-D03 Home e Perfil montados juntos concordam em 8 estados
00:02 +25: H-D identidade em movimento H-D04 logout com as telas montadas apaga o avatar na hora
00:03 +26: H-D identidade em movimento H-D05 na janela da troca A→B o avatar de A não pisca
00:03 +27: H-D identidade em movimento H-D06 resposta ATRASADA da conta A não contamina a conta B
00:03 +28: H-D identidade em movimento H-D07 válida→inválida e inválida→válida, nos dois sentidos
00:03 +29: H-D identidade em movimento H-D08 60 reconstruções de cada tela não emitem chamada
00:04 +30: H-D identidade em movimento H-D09 abrir e fechar o Perfil 6 vezes não emite chamada
00:05 +31: H-D identidade em movimento H-D11 a troca de avatar não devolve o Perfil ao esqueleto
00:05 +32: H-D identidade em movimento H-D10 falha de identidade não inventa avatar
00:05 +33: H-E auditoria estrutural (setUpAll)
00:05 +33: H-E auditoria estrutural H-E01 main.dart continua byte a byte o da base
00:05 +34: H-E auditoria estrutural H-E02 authStateChanges tem UM assinante, e é a sessão
00:05 +35: H-E auditoria estrutural H-E03 obterMinhaIdentidade é chamado de UM lugar só
00:05 +36: H-E auditoria estrutural H-E04 nem Home nem Perfil alcançam Firestore ou publicProfiles
00:05 +37: H-E auditoria estrutural H-E05 o fecho cresceu só pelo resolvedor
00:05 +38: H-E auditoria estrutural H-E06 a coroa tem UM dono NA FUNÇÃO DE AVATAR
00:05 +39: H-E auditoria estrutural H-E07 nenhuma tela inventa catálogo nem mapeia referência a arquivo
00:05 +40: H-E auditoria estrutural H-E09 nenhum produtor de produção escreve um avatar literal
00:05 +41: H-E auditoria estrutural H-E08 o delta não carrega credencial, segredo nem dado pessoal
00:05 +42: H-E auditoria estrutural (tearDownAll)
...
00:01 +3: A visita B V3 o nome é o de B
00:01 +4: A visita B V4 o avatar é o de B
00:01 +5: A visita B V5 a liga é a de B
00:01 +6: A visita B V6 as estatísticas são as de B
00:01 +7: A visita B V7 o nome de A NUNCA aparece no perfil de B
...
00:02 +20: falha, fallback e privacidade V16b referência malformada cai no mesmo fallback
00:02 +21: falha, fallback e privacidade V17 a projeção pública não tem campo privado
00:02 +22: falha, fallback e privacidade V17b nada de privado chega à tela do visitado
00:02 +23: guarda estrutural V-guarda o caminho visitado não alcança a identidade da sessão
00:02 +24: guarda estrutural V-guarda o serviço não tem segunda fonte de identidade
...
00:02 +28: N11 — os estados da tela N11e — SEM TEMPORADA não vira erro nem botão
00:02 +29: N11 — os estados da tela N11f — SUCESSO desenha o que veio, e `posicao: 0` vira —
00:02 +30: N11 — os estados da tela N11g — fora do escopo de ranking a tela não afirma nada
00:02 +31: N12–N13 — nada de maquete no caminho (setUpAll)
00:02 +31: N12–N13 — nada de maquete no caminho N12 — Hall, Amigos e a tela de Ranking de maquete ficam de fora
00:02 +32: N12–N13 — nada de maquete no caminho N13 — nenhum slug de maquete existe no código alcançável
00:02 +33: N12–N13 — nada de maquete no caminho N13b — `publicIdVisitado` só recebe o campo da projeção
...
00:01 +2: Home — as duas autoridades no mesmo cabeçalho Ranking real: a liga é exibível
00:01 +3: Home — as duas autoridades no mesmo cabeçalho Ranking provisório: a liga é omitida
...
00:02 +11: troca de identidade A → B nem avatar nem Ranking de A permanecem no Perfil aberto
00:02 +12: troca de identidade A → B logout apaga o avatar e o Ranking de uma vez
00:02 +13: navegação preserva o publicId o Perfil aberto por publicId consulta AQUELE publicId
00:02 +14: navegação preserva o publicId visitar dois perfis diferentes consulta os dois ids
...
00:02 +17: C12–C15 — as invariantes da base sob a tabela nova C13 ranking ausente não vira Bronze nem colocação zero
00:02 +18: C12–C15 — as invariantes da base sob a tabela nova C14 a barreira temporal continua de pé sob o abrirRanking novo
00:02 +19: C12–C15 — as invariantes da base sob a tabela nova C15 três toques simultâneos abrem UMA consulta
00:02 +20: a identidade do terceiro — pendência RESOLVIDA o perfil visitado é do visitado, nos quatro campos
00:02 +21: a identidade do terceiro — pendência RESOLVIDA a liga da sessão NÃO mascara a do visitado
...
00:01 +3: Amigos — as listas vêm da autoridade trocar de aba consulta a aba nova, e só ela
00:01 +4: Amigos — as listas vêm da autoridade o botão da aba de recebidas é o VERBO da ação
...
00:02 +10: navegação — o publicId, e nunca a posição tocar num amigo abre o Perfil daquele publicId
00:02 +11: navegação — o publicId, e nunca a posição um resultado que É você abre o perfil do DONO
00:02 +12: Perfil visitado — a relação vem do social, e volta depois da ação a faixa mostra o rótulo e os botões da autoridade
00:02 +13: Perfil visitado — a relação vem do social, e volta depois da ação o perfil do DONO não tem faixa social nem consulta relação
00:02 +14: Perfil visitado — a relação vem do social, e volta depois da ação `ehMeuPerfil` VENCE um `publicIdVisitado` escrito junto
...
## a11yamigos (tail)
```
00:06 +51: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — busca com resultado
00:06 +52: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — busca truncada
00:06 +53: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — busca truncada
00:06 +54: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — busca truncada
00:06 +55: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — falha de lista
00:07 +56: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — falha de lista
00:07 +57: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — falha de lista
00:07 +58: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — falha de busca
00:07 +59: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — falha de busca
00:07 +60: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — falha de busca
00:07 +61: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — vazio
00:07 +62: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — vazio
00:07 +63: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — vazio
00:07 +64: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — carregando
00:07 +65: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — carregando
00:07 +66: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — carregando
00:07 +67: 4 — a semântica exemplar continua de pé 4e — nenhum anúncio duplicado — fora do escopo
00:07 +68: 4 — a semântica exemplar continua de pé 4f — a ordem de foco desce a tela — fora do escopo
00:07 +69: 4 — a semântica exemplar continua de pé 4g — nenhum UID na árvore — fora do escopo
00:07 +70: 5 — vazio, carregando, erro e conteúdo 5a — vazio diz a frase da aba, e não desenha alvo de lista
00:07 +71: 5 — vazio, carregando, erro e conteúdo 5b — carregando mostra o progresso
00:07 +72: 5 — vazio, carregando, erro e conteúdo 5c — erro oferece Tentar de novo, no piso
00:07 +73: 5 — vazio, carregando, erro e conteúdo 5d — conteúdo continua desenhando quem o servidor mandou
00:07 +74: 5 — vazio, carregando, erro e conteúdo 5e — fora do escopo diz o motivo, e o Voltar continua no piso
00:07 +75: All tests passed!
```
