...
readonly PISOS_CASOS="comunicacao:81 portaoci:228 contratosui:68 rankingfn:465 autverif:96"
...
readonly PISOS_EXIGE="comunicacao:35 chatdom:6 portaoci:49 contratosui:29 rankingfn:15 \
avatarcanon:4 avatarhml:4 perfilvis:4 rknavpub:4 compavrank:3 compnavpub:3 \
socialestado:3 socialleitor:3 socialtela:2 audsocial:4 a11yamigos:3 autverif:18"
